...
<body>
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active"><a href="films.jsp">Peliculas</a></li>
		</ol>
	</nav>
	...
	<%
		request.setAttribute("products", ProductDaoImpl.getForType(-1, true, 1));
					...
					<div class="modal-content">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-success"
								data-dismiss="modal">CERRAR</button><c:choose>
								<c:when test="${role=='user'}">
